...
let zMove=scrollper * 3950 - 1950;//.world .stage .house에서 준 -500 값이 중복 적용되어서 500 빼주고 마지막 너무 빠져있어서 30만큼 덜줌?, 빈틈때문에 490으로 수정 
houseEle.style.transform=`translateZ(${zMove}vw)`;
})

window.addEventListener('mousemove',function(e){
    mousePos.x=(e.clientX / window.innerWidth) * 8;
    mousePos.y=-(e.clientY / window.innerHeight) * 8;
